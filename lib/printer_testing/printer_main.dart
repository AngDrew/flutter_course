...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initSavetoPath() async {
    ...
    final filename = 'doge.png';
    var bytes = await rootBundle.load("assets/doge.png");
  ...
  List<DropdownMenuItem<BluetoothDevice>> _getDeviceItems() {
    ...
    if (_devices.isEmpty) {
      ...
      _devices.forEach((device) {
        items.add(DropdownMenuItem(
          child: Text(device.name ?? 'NO DEVICE'),
          value: device,
        ));
      });
    }
...
//write to app path
  ...
  Future show(
    ...
    await Future<void>.delayed(new Duration(milliseconds: 100));
